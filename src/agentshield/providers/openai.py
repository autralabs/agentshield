...
from agentshield.core.exceptions import EmbeddingError
...
class OpenAIEmbeddingProvider:
    ...
    Requires the 'openai' extra: pip install agentshield[openai]
        ...
        if self._client is None:
            try:
                ...
                raise ImportError(
                    ...
                    "Install with: pip install agentshield[openai]"
                ) from e
