...
from agentshield.core.config import ShieldConfig, get_cache_dir
from agentshield.core.results import ScanResult, DetectionSignal, ScanDetails

if TYPE_CHECKING:
    from agentshield.detectors.base import BaseDetector
...
class AgentShield:
    ...
    With finetuned cleaner:
        ...
        ...     "cleaning": {
        ...         "method": "finetuned",
        ...         "finetuned": {"model_id": "agentshield/cleaner-phi2-lora"}
        ...     }
        ... })
    ...
    def _create_text_cleaner(self) -> TextCleaner:
        ...
        if method == "heuristic":
            ...
            from agentshield.cleaning.hybrid import create_hybrid_cleaner
