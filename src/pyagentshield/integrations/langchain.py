...
class ShieldRunnable:
    ...
    def __init__(
        ...
        Args:
            config: AgentShield configuration
        ...
        if self.on_detect == "block":
            ...
            for i, (doc, result) in enumerate(zip(docs, results)):
                if hasattr(doc, "metadata"):
                    doc.metadata["_agentshield"] = result.to_dict()
                elif isinstance(doc, dict):
                    doc["_agentshield"] = result.to_dict()
            return docs
    ...
    def __or__(self, other: Any) -> Any:
        ...
        try:
            ...
            raise ImportError(
                ...
                "Install with: pip install pyagentshield[langchain]"
            )
